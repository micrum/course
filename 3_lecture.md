...
агульны CSS файл (ці падключацца паасобку у development асяроддзі). Гэта
...
Зараз кліентская частка нашага прыкладання больш падобная да рэальнага вэб-сайту, хаця
